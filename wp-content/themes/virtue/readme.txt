...
= Version: 2.0.2 =
* Fix Minor Portfolio Grid issue
* Pre review request updated custom.php 
* Update woocommerce files for 2.1
* Fix portfolio carousel

= Version: 2.0.1 =
* Woocommerce 2.1 support updates
* Fix Touch click on android.
* Add tumblr icon to social widget
* Updated Languages
...
* Changed Theme Lightbox to prettyPhoto
* Change gMap to GMAP3 Plugin for JQuery
